definePlugin('@plugins/com.msgbyte.draw/DrawModal-1bcff596.js', ['exports', '@capital/common', '@capital/component', 'react', './index-b9e407c9'], (function (exports, common, component, React, index$1) { 'use strict';
  ...
  var LazyBrush$1 = function () {
    ...
    function LazyBrush() {
      ...
      this.pointer = new _LazyPoint2$1.default(initialPoint.x, initialPoint.y);
  ...
  var CoordinateSystem = /*#__PURE__*/function () {
    ...
    function CoordinateSystem(_ref) {
      ...
      _defineProperty$2(this, "setView", function (view) {
        var newView = _this.clampView(_extends$1({}, _this._view, view || {}));
      ...
      _defineProperty$2(this, "scaleAtClientPoint", function (deltaScale, clientPoint) {
        var viewPt = _this.clientPointToViewPoint(clientPoint);

        var newView = _this.clampView(_extends$1({}, _this._view, {
      ...
      _defineProperty$2(this, "clientPointToViewPoint", function (_ref4, view) {
      ...
      _defineProperty$2(this, "viewPointToClientPoint", function (_ref6, view) {
        var x = _ref6.x,
            y = _ref6.y;
      ...
      _defineProperty$2(this, "attachViewChangeListener", function (listener) {
  ...
  const DrawModal = React__default["default"].memo(({ actions, onSuccess }) => {
    ...
    const [{ loading }, handleSend] = common.useAsyncFn(async () => {
      ...
      sendMsg(common.getMessageTextDecorators().image(res.url, { width: 400, height: 400 }));
      onSuccess();
    }, [sendMsg, onSuccess]);
    return /* @__PURE__ */ React__default["default"].createElement("div", null, /* @__PURE__ */ React__default["default"].createElement(CanvasDraw, {
      ref: drawRef
